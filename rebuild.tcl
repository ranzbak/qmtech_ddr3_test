...
#
# Generated by Vivado on Fri May 01 22:11:08 CEST 2020
...
set file "$origin_dir/rtl/verilog/openaars_minimig_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets constrs_100t]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../../open_aars_minimig/cons/xc7a100t/ddr3.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a100tfgg676-2" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../../open_aars_minimig/cons/xc7a100t/ddr3.xdc"]" -objects $obj
